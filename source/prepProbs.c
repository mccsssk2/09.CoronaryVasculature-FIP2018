...
double connRCA[12][12], 			connLAD[12][12], 			connLCX[12][12]			;
double prob_connRCA[12][12], 	prob_connLAD[12][12], 	prob_connLCX[12][12]		;
double cuprob_connRCA[12][12], 	cuprob_connLAD[12][12], 	cuprob_connLCX[12][12]		;
...
//		printf("CU: %f\n", cuprob_connRCA[row2][colum] );
// print it out.
printf("RCA probability matrix:\n");
for(row=0; row<12; row++){
for(colum=0; colum<12; colum++)		
		printf("%2.3f\t", cuprob_connRCA[row][colum]);
		printf("\n");
}
...
for(row=0; row<12; row++){
for(colum=0; colum<12; colum++)		
		printf("%2.3f\t", cuprob_connLAD[row][colum]);
		printf("\n");
}
...
for(row=0; row<12; row++){
for(colum=0; colum<12; colum++)		
		printf("%2.3f\t", cuprob_connLCX[row][colum]);
		printf("\n");
}
